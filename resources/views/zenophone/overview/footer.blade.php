<x-footer 
    ...
    bg="bg-[#163F22]" 
    newsletterTitle="Zenophone Newsletter"
    newsletterDesc="Stay up to date with the latest news and stories from Zenophone."
    :menus="[
        'Support' => [
        ...
        'Products' => [
            ['label' => 'Zenophone', 'url' => '/products/onebuds'],
            ['label' => 'Zenophone with', 'url' => '/products/onebuds'],
