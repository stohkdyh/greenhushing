...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-gray-500 font-medium leading-5 text-gray-900 focus:outline-none focus:border-black transition duration-150 ease-in-out'
