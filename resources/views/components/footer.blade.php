<footer class="bg-[#163F22] text-white py-10 px-4">
    <div class="max-w-7xl mx-auto space-y-8">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 text-sm">
            <!-- Brand -->
            <div class="flex flex-col items-start">
                <h2 class="text-3xl font-bold text-white">Onephone</h2>
                <img src="images/logo_claim_green.png" alt="logo onephone" class="h-16 mt-1 w-auto">
            </div>

            <!-- Newsletter -->
            <div class="max-w-md w-full md:ml-4">
                <h3 class="text-white font-semibold">Onephone Newsletter</h3>
                <p class="text-white/70 mb-4 text-sm">Stay up to date with the latest news and stories from Onephone.</p>
