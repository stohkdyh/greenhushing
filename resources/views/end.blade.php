...
<body style="background-image: url('{{ asset('images/welcome_bg.jpg') }}');"
    class="bg-repeat bg-center bg-contain text-[#1b1b18] flex items-center min-h-screen flex-col">

    <!-- Logo Header -->
    <div
        class="bg-white bg-opacity-40 backdrop-blur-md flex items-center w-fit h-fit gap-3 px-4 py-2 mb-12 rounded-full border-white shadow-lg top-8 z-10 sticky">
    ...
    <div
        ...
        <div class="flex flex-col items-center justify-center w-full text-center">
            ...
            <div class="mb-8 mt-10">
                <div
                    class="w-24 h-24 bg-green-500 rounded-full flex items-center justify-center mx-auto mb-4 animate-pulse">
            ...
            <!-- Thank You Message -->
            <h1 class="text-4xl lg:text-5xl font-bold mb-4 text-green-700">
                {{ __('Thank You!') }}
            </h1>

            <h2 class="text-2xl lg:text-3xl font-semibold mb-6 text-gray-800">
            ...
            <div class="flex flex-col sm:flex-row gap-4 mt-8">
                ...
                <a href="{{ route('welcome') }}"
                    class="px-6 py-3 bg-gray-600 text-white rounded-full hover:bg-gray-700 transition-colors shadow-lg text-center">
                    {{ __('Start New Survey') }}
                </a>
            </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Auto-hide participant ID after 10 seconds for privacy
            setTimeout(function() {
